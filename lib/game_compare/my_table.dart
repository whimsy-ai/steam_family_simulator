...
class MyTable extends StatefulWidget {
  ...
  final Widget Function(BuildContext context, int row)? separatorBuilder;
...
class _MyTableState extends State<MyTable> {
  ...
  late LinkedScrollControllerGroup _horizontals, _verticals;
  ...
  void initState() {
    ...
    _verticals = LinkedScrollControllerGroup();
  ...
  void didUpdateWidget(oldWidget) {
    ...
    // print('didUpdateWidget rowCount ${widget.rowCount}, ${_controllers.length}');
                ...
                Expanded(
                  child: ListView.separated(
                    ...
                    separatorBuilder: (c, i) =>
                        widget.separatorBuilder?.call(context, i) ?? Divider(),
                  ),
                ),
              ],
            );
    ...
    return SizedBox(
      ...
      child: ListView.separated(
        separatorBuilder: (context, i) =>
            widget.separatorBuilder?.call(context, i) ?? SizedBox.shrink(),
        scrollDirection: Axis.horizontal,
